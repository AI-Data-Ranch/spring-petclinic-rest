...
public interface ClinicService {
	...
	Page<Owner> findOwners(Pageable pageable) throws DataAccessException;
	Page<Owner> findOwnersByLastName(String lastName, Pageable pageable) throws DataAccessException;
